...
function jogoFinalizado() {
    const cartasSelecionadas = primeiraColuna.querySelectorAll(".carta-clicada").length;
    const cartasClicadas2 = segundaColuna.querySelectorAll(".carta-clicada").length;
    if (cartasSelecionadas + cartasClicadas2 === quantidadeCartas) {
    ...
    } else if (cartasSelecionadas + cartasClicadas2 === quantidadeCartas) {
